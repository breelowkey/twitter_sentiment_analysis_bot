...
driver = webdriver.Chrome(executable_path="/Users/breenda/Desktop/chromedriver", chrome_options=chrome_options)
...
def get_data(url):
    main(driver,usr, pwd,file_path,url)
